...
public class MainClass12 {
	public static void main(String[] args) {				
		try {
			//객체
			FileInputStream fis=new FileInputStream("C:/Users/user/playground/myFolder/1.jpg");
			//byte 알갱이를 File 에 출력할 객체 생성
			FileOutputStream fos=new FileOutputStream("C:/Users/user/playground/myFolder/copied.jpg");
